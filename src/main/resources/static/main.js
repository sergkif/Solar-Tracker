...
function () {
  ...
  _createClass(Article, [{
    ...
    value: function createArticle(title, content, image) {
      ...
      edit.innerHTML = "edit";
      h1.appendChild(edit);
      new _modal_Modal__WEBPACK_IMPORTED_MODULE_1__["default"](this.id, this.title, this.content, edit);
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return fetch("article/ + ".concat(this.id), {
                  method: 'DELETE'
...
function () {
  function Controller() {
    ...
    this.menu.subscribe(function (data) {
      ...
      _this.httpGet("article/".concat(data.id)).then(function (article) {
        new _article_Article__WEBPACK_IMPORTED_MODULE_1__["default"](article);
  ...
  _createClass(Controller, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(theUrl) {
        var data;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
...
/* harmony import */ var _EventObserver__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../EventObserver */ "./src/EventObserver.js");
...
function (_EventObserver) {
  _inherits(Header, _EventObserver);
  ...
  return Header;
}(_EventObserver__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
var controller = new _controller_Controller__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
/* harmony import */ var _modal_Modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modal/Modal */ "./src/modal/Modal.js");
var _class;
...
function (_EventObserver) {
  ...
  _createClass(Menu, [{
    ...
    value: function createMenu() {
      ...
      new _modal_Modal__WEBPACK_IMPORTED_MODULE_2__["default"]('', '', '', create);
    }
  }, {
    key: "httpGet",
    value: function () {
    ...
    key: "sendTitle",
    value: function sendTitle(e) {
      this.broadcast({
        id: e.target.dataset.artId
      });
    }
  }]);

  return Menu;
}(_EventObserver__WEBPACK_IMPORTED_MODULE_1__["default"]), (_applyDecoratedDescriptor(_class.prototype, "sendTitle", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "sendTitle"), _class.prototype)), _class);
...
/*#__PURE__*/
function () {
  function Modal(id, title, content, openButton) {
  ...
  _createClass(Modal, [{
    key: "toggleMethod",
    value: function toggleMethod(element, modal, overlay) {
    ...
    key: "httpPost",
    value: function () {
      var _httpPost = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee() {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
